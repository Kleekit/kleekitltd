        ...
        <section class="heroSection">
          <div class="row">
            <div class="col-md-6 box">
              <h1 class="Top">
                Looking for a revolutionary Solution for your business??
              </h1>
              <h4>
        ...
        <section class="firstProject">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-6">
              ...
              <p>
                Mora clothing is an ecommerce business that deals on male
                fashion, to expand their customer reach they needed a webite
                that displays all available products in sizes, colour and prize,
                take orders and also make payments.
              </p>
            </div>
            <div class="col-md-6 box">
        ...
        <section class="secondProject">
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-6 order-1 order-md-2">
              ...
              <p>
                EasyDoc is an application that connects patients with doctors,
                this app allows patients to book appointments with various
                doctors and directly consult with these doctors, get
        ...
        <section class="thirdProject">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-6 box">
              ...
              <p>
                VOREM is a cryptocurrency and digital asset exchange platform
                that allows users to buy, sell and exchange cryptocurrency by
                creating a market place for all users to sell and buy giving
                them the chance to decide who they want to buy from and also
                allow sellers to set their individual rates.
              </p>
